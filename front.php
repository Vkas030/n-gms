...
<header>
    ...
    <nav class="navbar navbar-expand-lg bg-white">
        <div class="container-fluid">
            <!-- logo -->
            <a class="navbar-brand ps-4 " href="#"><img src="img/logoo.png" alt="" style="height: 50px; "></a>
            <!-- toggler btn -->
    ...
    <div class="container py-4">
        <div class="row py-5 px-5 box">
            ...
            <div class="col-md-3 box1">
                ...
                <span><input name="eid" id="eid" type="email" name="email" size="30"
                        placeholder="example@xyz.com"></span>
                <button class="btn mt-4 btn-primary" style="background:#4eaebf; border:none;"
                    onclick="btnSubscribe()">Subscribe</button>
            </div>
        </div>
        <div class="row py-2">
            <div class="col-md-6 px-5 py-2">
                ...
                <form action="#" method="post" onsubmit="btnSave()">
                    ...
                    <button type="submit" class="btn btn-primary" style="background:#4eaebf; border:none;">Register
                        Now</button>
                </form>
            </div>
        </div>
        <footer class="main-footer text-center shadow text-white" style="background:#428f9d;">
